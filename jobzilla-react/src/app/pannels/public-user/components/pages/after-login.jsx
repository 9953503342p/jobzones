        ...
        <>
            ...
            <div className="section-full popup-form">
                <div className="loginbg">
                    <div className="container1" style={{ borderRadius: '40px' }}>
                        <div className="row popup-form-section align-items-center text-center d-flex justify-content-center ">
                            ...
                            <div className="col-xl-5 col-lg-5 col-md-5 col-12 popup-cards-right">
...
<h1 style={{fontSize:'15px', marginTop:'10px'}}>Don't have an Account      <a className="twm-nav-sign-up" data-bs-toggle="modal" href="#sign_up_popup" role="button" style={{color:'blue'}}>
                                                 Sign Up!
                                            </a></h1>
                        </div>
                                                </div>
